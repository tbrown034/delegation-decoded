  ...
  return (
    <section className="mb-10 rounded border border-neutral-200 bg-stone-50 p-4">
      ...
      <p className="mt-1 max-w-2xl text-[12px] text-neutral-600">
        Every data source on the site, mapped to this member. A grey dot means
        the source may not apply or its coverage is still being developed; read
        the source note before treating an empty record as a finding.
      </p>
