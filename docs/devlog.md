...
- Added a manual `research` workflow mode that runs only candidate and member evidence collection, cleanup and health checks. It avoids replaying the roster and finance pipelines when an evidence-only recovery is needed.
