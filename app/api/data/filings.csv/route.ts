...
export async function GET(request: Request) {
  ...
  const stream = keysetCsvStream({
    ...
    nextBatch: async () => {
      ...
      return rows.map((r) => [r.filing_id, r.doc_id, r.chamber, r.bioguide_id, r.first_name, r.last_name, r.state_code, r.district, r.party, r.filing_type, r.filed_date, r.parse_status, r.parse_confidence, r.page_count, r.tx_count, r.pdf_url]);
    },
  });
