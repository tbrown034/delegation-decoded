...
scripts/ingest/
  ...
  elections.ts            State-authority race adapter runner. Indiana backfills a completed primary; Delaware, Florida and Rhode Island track current qualifying status, including inactive history. Rhode Island's workbook supplies explicit ballot-qualification fields. Private Blob snapshots precede append-only status/result writes. FEC remains the labeled fallback where no adapter is covered.
